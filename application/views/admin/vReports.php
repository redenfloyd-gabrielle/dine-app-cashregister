<div class="pusher">
    ...
    <div class='ui padded segment'>
        ...
        ?>
            ...
            <a class='section' href='<?php echo site_url()?>/CReports/getData/<?php echo 'Daily' ?>'><button>Daily</button></a>
            <a class='section' href='<?php echo site_url()?>/CReports/getData/<?php echo 'Weekly' ?>'><button>Weekly</button></a>
            <a class='section' href='<?php echo site_url()?>/CReports/getData/<?php echo 'Monthly' ?>'><button>Monthly</button></a>
            <a class='section' href='<?php echo site_url()?>/CReports/getData/<?php echo 'Over' ?>'><button>Over All</button></a>
