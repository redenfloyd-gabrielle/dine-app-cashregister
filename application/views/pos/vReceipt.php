...
<div class="receiptbox">
   ...
   <span class="lft info">
      Cashier : <strong>Employee1</strong> 
   </span>
   <span class="rght info">
      Order No. : <strong> 1234567</strong>
   </span><br>
   <span class="lft info">
      Date : <strong>17/12/2017</strong> 
   </span>
   <span class="rght info">
      Time : <strong> 11:00 AM</strong>
   </span><br>
   <div class="receiptdivide"> </div>
   <table class="receipttbl">
     ...
     <tr>
       <td class="lft receiptcontent">1</td>
       <td class="receiptcontent">Product 1</td>
       <td class="rght receiptcontent">P450.00</td>
     </tr>
     <tr>
      <td class="lft receiptcontent">2</td>
      <td class="receiptcontent">Product 2</td>
      <td class="rght receiptcontent">P600.00</td>
    </tr>
    <tr>
      <td class="lft receiptcontent">1</td>
      <td class="receiptcontent">Product 3</td>
      <td class="rght receiptcontent">P100.00</td>
    </tr>
   </table>
   <div class="receiptdivide"> </div>
  <span class="lft receiptamt">Amount Due</span>
  <span class="rght receiptamt">P1150.00</span>
  <span class="lft receipttbl receiptcontent">Cash
    <span class="rght ">P2000.00</span>
  </span>
  <span class="lft receipttbl receiptcontent">Change
    <span class="rght ">P850.00</span>
  </span><br><br><br><br>
  <div class="receiptdivide"> </div>
