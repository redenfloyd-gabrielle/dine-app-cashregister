...
<div class="ui large top attached inverted teal menu borderless">
	<a class="item">DINE | POS</a>
	<div class="right menu">
		<div class="item">
			<span style="text-transform: uppercase;"><?php echo $this->session->userdata['userSession']['user_first_name'].' '.$this->session->userdata['userSession']['user_last_name'];?> &nbsp &nbsp | &nbsp &nbsp <span id="date"></span>&nbsp &nbsp | &nbsp &nbsp <span class ="time" ></span>&nbsp &nbsp</span>
		</div>
